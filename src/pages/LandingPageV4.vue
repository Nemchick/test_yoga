            ...
            <div class="section__content" style="margin-bottom: 0px">
              ...
              <div class="kirill_section_button_lending">
                <div class="kirill_conteiner_vector_button">
                  ...
                  <router-link
                    to="/survey/"
                    class="button kirill_button--s1 button--t1 pages_v4"
                  >
                    Подобрать программу
                  </router-link>
                </div>
...
import StartComponent from '@/components/UI/Components/StartComponent.vue'
...
export default {
  ...
  metaInfo() {
    return {
      title:
        'Йога онлайн с индивидуальным подбором | Yoga Care — практика в любом месте и время',
      meta: [
        {
          vmid: 'description',
          name: 'description',
          content:
            'Онлайн-йога с индивидуальной программой: пройдите тест и получите подборку практик под ваше состояние. Занимайтесь где угодно, отслеживайте успехи, развивайтесь с Yoga Care. 7 дней бесплатно!',
        },
        {
          vmid: 'keywords',
          name: 'keywords',
...
/* .kirill_section_button_lending {
  display: none;
} */
.kirill_conteiner_vector_button {
...
@media (max-width: 767px) {
  .kirill_section_description_lending {
    max-width: 100%;
  }
  .kirill_conteiner_vector_button {
