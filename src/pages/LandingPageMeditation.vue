          ...
          <div class="container test">
            <div class="section__content" style="margin-bottom: 0px">
              <h1 class="kirill_section__title_lending">
                Подберём медитации под ваше состояние
              </h1>
              <div class="kirill_section_description_lending">
                Отобрали самые эффективные практики кундалини-йоги, чтобы
                избавиться от суеты и стресса, приобрести душевный покой и
                внутреннюю гармонию
              </div>
              ...
              <div class="kirill_section_button_lending">
                <div class="kirill_conteiner_vector_button_v2">
                  <div class="kirill_conteiner_vector_text_v2">
                    Получите персональную подборку практик. Заполните анкету от
                    практикующего психолога, это займет около 6 минут
                  </div>
                  <router-link
                    to="/survey/"
