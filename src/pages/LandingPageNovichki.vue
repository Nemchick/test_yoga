        ...
        <section class="section section--01">
          <div class="container test">
            <div class="section__content" style="margin-bottom: 0px">
              <h1 class="kirill_section__title_lending_v2">
                Кундалини йога: эффективные и простые программы для новичков
              </h1>
              <div class="kirill_section_description_lending">
                38 программ от профессионалов йоги и психологии: улучшение
                настроения, снижение стресса, укрепление здоровья и гибкое тело.
                Видеоуроки с подсказками.
              </div>
              ...
              <div class="kirill_section_button_lending">
                <div class="kirill_conteiner_vector_button_v2">
                  <div class="kirill_conteiner_vector_text_v2">
                    Получите персональную программу, и занимайтесь<br />
                    <span class="kirill_conteiner_text_novichki"
                      >7 дней бесплатно</span
                    >
                    <img
                      class="kirill_conteiner_vector_two_v2"
                  ...
                  <router-link
                    to="/survey/"
                    class="button kirill_button--s1 button--t1 button_white_kirill"
                  >
                    Подобрать программу
                  </router-link>
                </div>
            ...
            <img
              ...
              class="kirill_lending_yoga_img_v3"
              alt="body"
              loading="eager"
            />
            <img
