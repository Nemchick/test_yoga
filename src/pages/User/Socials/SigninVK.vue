        ...
        <div class="form-wrapper">
          <div class="form form--confirm">
            <div class="form__heading">
              <h2 class="form__title">Авторизация VK</h2>
              <LoaderComponent v-if="localLoading" />
              <div class="form__subtitle" v-else-if="errorLinking === false">
                Выполняется авторизация через учетную запись VK
              </div>
              <div class="form__subtitle" v-else>
                При попытке авторизации через учетную запись VK произошла ошибка
              </div>
            </div>
          </div>
        </div>
