          ...
          <div class="container test">
            <div class="section__content" style="margin-bottom: 0px">
              <h1 class="kirill_section__title_lending">
                Кундалини-йога <br />7 дней бесплатно
              </h1>
              <div class="kirill_section_description_lending">
                Составьте персональную программу тренировок и практик с помощью
                анкеты и занимайтесь в любое время и в любом месте.
              </div>
              ...
              <div class="kirill_section_button_lending">
                ...
                <div class="kirill_conteiner_vector_button">
                  ...
                  <router-link
                    to="/survey/"
                    class="button kirill_button--s1 button--t1 pages_v1"
                  >
                    Подобрать программу
                  </router-link>
                </div>
