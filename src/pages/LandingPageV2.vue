          ...
          <div class="container test">
            <div class="section__content" style="margin-bottom: 0px">
              <h1 class="kirill_section__title_lending">
                Индивидуальная<br />
                йога-программа для души и тела.
              </h1>
              <div class="kirill_section_description_lending">
                Занимайтесь кундалини-йогой где и когда вам удобно. Персональная
                программа и доступ к видеобиблиотеке практик и медитаций<br />
                бесплатно на 7 дней.
              </div>
              ...
              <div class="kirill_section_button_lending">
                ...
                <div class="kirill_conteiner_vector_button">
                  ...
                  <router-link
                    to="/survey/"
                    class="button kirill_button--s1 button--t1 pages_v2"
                  >
                    Подобрать программу
                  </router-link>
                </div>
