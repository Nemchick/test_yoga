<!-- components/SubscriptionModal.vue -->
<template>
    ...
    <div class="kirill_main_secton_pay_new">
      <div class="kirill_main_secton_pay_new">
        <div class="kirill_container_new_text_pay">
          ...
          />
          <button class="kirill_link_cross mobile_block" @click="onClose">
            <i class="icon-close"></i>
          </button>
        </div>
        <div class="container kirill_pay_container_new">
          <button class="kirill_link_cross non_mobil" @click="onClose">
            <i class="icon-close"></i>
          </button>
          <div class="kirill_title_pay">
            Для полного доступа выберите подходящий вам тариф и нажмите «Начать
            заниматься»
          </div>
            ...
            <div class="form form--promocode">
              <div class="form__section form__section--promocode">
                ...
                >
                  ...
                  ></i>
                  <i v-show="promocodeError" class="icon-close color_red"></i>
                  <!-- <div
          ...
          <div class="kirill_bay_text">
            Для подтверждения вашей карты будет списано 10 рублей, которые мы
            сразу вернем. Сумма тарифа оплачивается через 7 дней. В любой момент
            можно будет отменить подписку
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  mounted() {
    ...
    // Скрыть элементы .header и .menu-mobile
    document.querySelectorAll('.header, .menu-mobile').forEach((el) => {
